...
# this part of the code helps the customer and the shippers to keep in touch so if there's something wrong with the product or the person ordering the item hasent gotten it yet they can talk to the shipper.
@views.route('/profile')
@cross_origin()
def profile():
    try:
