...
# this part of the code shows the data base of all the customers ordering toys from the company and setting them byt with email and contact info
...
# this part of the code sorts out all the toys by most expensive to least expensive
product_json = [
	{
