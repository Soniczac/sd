...
# this code helps out the customers log into the toy wedsite and if the customer enters the wrong email/password it'll throw an error and not allowing them to log into their account.
